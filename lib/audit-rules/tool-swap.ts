...
export const toolSwapRules: ToolSwapRule[] = [
  {
    ...
    from: "Cursor",
    to: "GitHub Copilot",
    get fromPrice() { return getPlanPrice("Cursor", "Pro") || 20; },
    get toPrice() { return getPlanPrice("GitHub Copilot", "Individual") || 10; },
    ...
    get estimatedSavings() { return (getPlanPrice("Cursor", "Pro") || 20) - (getPlanPrice("GitHub Copilot", "Individual") || 10); },
  },
...

  {
    ...
    from: "Windsurf",
    to: "GitHub Copilot",
    get fromPrice() { return getPlanPrice("Windsurf", "Pro") || 15; },
    get toPrice() { return getPlanPrice("GitHub Copilot", "Individual") || 10; },
    condition: (useCase: string, _teamSize: number, _monthlySpend: number) => useCase === "coding",
    ...
    get estimatedSavings() { return (getPlanPrice("Windsurf", "Pro") || 15) - (getPlanPrice("GitHub Copilot", "Individual") || 10); },
  },
];
